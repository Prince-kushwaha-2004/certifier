...
export default function Table({ data, getData, setData }) {
    console.log(data)
                                    ...
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td className=" py-4 ps-2 whitespace-nowrap text-end text-sm font-medium">
                                                <DropDown id={value.id} type={"folder"} getData={getData} setData={setData} prev_name={value.folder_name} />
                                            </td>
                                        </tr>
                                    )
                                }) : ''}
                                {data.files ? data.files.map((value, index) => {
                                    return (
                                        <tr key={index}>
                                            ...
                                            <td className=" py-4 ps-2 whitespace-nowrap text-end text-sm font-medium">
                                                <DropDown id={value.id} type={"file"} getData={getData} setData={setData} prev_name={value.filename} />
                                            </td>
                                        </tr>
                                    )
                                }) : ''}

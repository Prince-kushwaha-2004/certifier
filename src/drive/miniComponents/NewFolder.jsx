...
export default function NewFolder({ open, setOpen }) {
    const [foldername, setFoldername] = useState('')
    const create = () => {
        setOpen(false)
        console.log(foldername)
        toast.success(foldername)
        setFoldername('')
    }
    return (
                        ...
                        <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <div className="mt-2">
                                        <input type='text' value={foldername} onChange={(event) => setFoldername(event.target.value)} className="w-full my-auto border text-black border-gray-300 text-xl p-2 px-4 gap-2 rounded-md focus:outline-blue-400" placeholder="New Folder" />
                                    </div>
                                </div>
                            </div>
                        </div>

...
export default function EmptyTrash({ open, setOpen, getData, setData }) {
    const emptyTrash = () => {
        apicall("delete", "file-manager/", '', '', (data) => {
            getData()
                        ...
                        <div className="bg-white dark:bg-neutral-700 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                            <div className="sm:flex sm:items-start">
                                ...
                                <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                                    ...
                                    <h1 className='text-xl font-semibold text-neutral-600 dark:text-white mt-2'>Are you Sure you want to Empty Trash</h1>
                                </div>
                            </div>
                        </div>
